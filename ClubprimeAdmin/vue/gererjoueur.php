...
$controller = new JoueurController($model);
?>
            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Ajouter un joueur</span></a>
                        </div>
                    </div>
                </div>
            ...
            <form  action="../controller/joueurcontroller.php" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="nombreMatchJoue" required>
                    </div>
                    <div class="form-group">
                        <label>Nombre de buts marqués</label>
                        <input type="number" class="form-control" name="nombreButMarque" required>
                    </div>
                    <div class="form-group">
                        <label>Nombre de passes décisives</label>
                        <input type="number" class="form-control" name="nombrePasseDecisive" required>
                    </div>
