            ...
            <div class="table-wrapper">
                ...
                <table class="table t2 table-striped table-hover">
                    <tbody>
                        ...
                        include(__DIR__ . "/../controller/liguecontroller.php");
                        ...
                        if (isset($_GET['id'])) {
                            ...
                            echo '<form method="post" action="supprimerligue.php">';
                            echo '<input id="submitmodifjoueur2" type="hidden" name="confirmSuppression" value="' . $id_ligue . '">';
                        ...
                        if (isset($_POST['confirmSuppression'])) {
                            $id_ligue = $_POST['confirmSuppression'];

                            try {
                                $controller = new ligueController();
                                $controller->supprimerLigue($id_ligue);
